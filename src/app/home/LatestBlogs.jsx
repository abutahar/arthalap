...
const LatestBlog = () => {
  return (
    <div className="flex mx-auto flex-col content-between ">
      <div className=" h-60">
        <img
          src="image_blog.jpg"
          alt="image"
      ...
      <div className=" min-h-20 flex-1 w-full flex flex-col    pb-4  mb-10">
        <h3 className="uppercase text-sm text-primary my-4 font-semibold">
          Monetary policy
        </h3>
        <h1 className="text-3xl font-semibold">
          Emerging markets nagivate gloval interest rate
        </h1>
        <div className="flex mt-auto justify-start  md:gap-4 pb-2 md:pb-4 items-center">
